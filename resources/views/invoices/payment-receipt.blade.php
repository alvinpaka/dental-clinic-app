  ...
  <div class="container">
    <div class="header" style="margin-bottom:6px;">
      <div style="display:flex; align-items:center; gap:12px;">
        <div style="width:28px; height:28px; border-radius:6px; background:#1D4ED8; display:flex; align-items:center; justify-content:center; color:white; font-weight:700; font-size:12px;">
          {{ strtoupper(substr(config('app.name'), 0, 2)) }}
        </div>
        <div>
          <div style="font-size:13px; font-weight:800;">{{ config('app.name') }}</div>
          <div class="muted">www.dentalclinicapp.com</div>
          <div class="muted">123 Main St, Entebbe · +256 700 000000</div>
        </div>
      </div>
    </div>
    ...
    <div class="footer">
      Generated by Dental Clinic App · This receipt acknowledges the payment received against the referenced invoice.
    </div>
