...
<body>
  <div class="container">
    <div class="header" style="margin-bottom:6px;">
      <div style="display:flex; align-items:center; gap:12px;">
        ...
        <div>
          ...
          <div class="muted">Email: vcare90@yahoo.com</div>
          <div class="muted">P.O.BOX 723, Plot 24, Gower's Rd,  <br>
                Entebbe, Uganda.</div>
          <div class="muted">Phone: +256 708720139</div>
        </div>
      </div>
    </div>
    ...
    <div class="footer">
      Generated by Victoria Dental Lounge · This receipt acknowledges the payment received against the referenced invoice.
    </div>
