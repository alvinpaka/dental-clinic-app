...
import { Plus, Search, MoreVertical, FileText, Calendar, Download, Eye, CreditCard, Receipt } from 'lucide-vue-next';
...
const openEdit = (invoice: Invoice) => {
  ...
  selectedPatient.value = props.patients.find(p => p.id === invoice.patient.id) || null;

  editForm.patient_id = invoice.patient.id;
